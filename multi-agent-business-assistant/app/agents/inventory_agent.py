...
# 3. If the product does not exist, clearly tell the user.
# 4. If requested quantity is greater than available stock, explain
#    how many units are actually available.
# 5. Keep responses concise and professional.
# 6. Do not calculate final order totals.
# 7. Do not handle shipping or delivery questions.
# """
